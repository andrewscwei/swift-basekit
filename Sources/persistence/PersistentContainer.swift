...
public final class PersistentContainer {
  ...
  @discardableResult public func perform<T>(block: @escaping (_ context: NSManagedObjectContext, _ coordinator: NSPersistentStoreCoordinator) throws -> T) async throws -> T {
