...
/// ```
///
/// **Warning**: This property wrapper uses private API and causes segmentation fault in the compiler if the type
/// constraint of the property owner is not satisfied.
@propertyWrapper
