...
/// Returns the typed value associated with a given object for a given key. The value is returned successfully if it
/// exists and can be typecast to `T`. Otherwise, `nil` is returned.
///
/// - Parameters:
