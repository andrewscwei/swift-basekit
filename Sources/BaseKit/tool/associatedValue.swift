...
/// Returns the typed value associated with a given object for a given key. The value is returned successfully if it exists and can be typecast to `T`. Otherwise, `nil` is returned.
///
/// - Parameters:
...
/// Returns the typed value associated with a given object for a given key with the option to provide a default value. The default value is only returned if a value does not exist or it cannot be typecast to `T`. When the default value is returned, it automatically becomes the new associated value.
///
/// - Parameters:
///   - object: The object of which the value is associated with.
///   - key: The key through which the value is associated with the object.
...
/// Associates a value with a given object using a given key via a strong reference to the associated object.
///
/// - Parameters:
